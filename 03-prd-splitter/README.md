...
| `/prd-activate <key>` | Verify Gumroad license, unlock Pro features | n/a |
...
[**Buy Pro on Gumroad →**](https://duolakit.gumroad.com/l/prd-splitter) *(coming soon)*
...
- `/prd-activate <license-key>` actually verifies against Gumroad
...
[MIT](../LICENSE) for the plugin source. Pro features (push, reviewer) verified via Gumroad license key.
...
| `/prd-activate <key>` | 校验 Gumroad license，解锁 Pro | — |
...
[**Gumroad 买 Pro →**](https://duolakit.gumroad.com/l/prd-splitter) *（即将上架）*
